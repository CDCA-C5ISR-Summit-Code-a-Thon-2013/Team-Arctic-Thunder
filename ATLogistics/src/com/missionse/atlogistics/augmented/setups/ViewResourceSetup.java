...
public class ViewResourceSetup extends DefaultMultiSetup {
	...
	public ViewResourceSetup(Activity parent) {
		super(parent, false);
	...
	@Override
	public void _a4_addDefaultMarkers(MarkerObjectMap markerObjectMap) {
		// TODO Auto-generated method stub

	}

	@Override
	public void _b2_addDefaultWorldObjects(World world) {
		...
		for(Resource r : resources){
			...
			Obj o = new Obj();
			o.setComp(itemMesh);
			o.setPosition(Vec.getNewRandomPosInXYPlane(
